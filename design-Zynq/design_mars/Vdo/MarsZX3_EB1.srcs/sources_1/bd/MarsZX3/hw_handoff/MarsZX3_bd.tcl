...
proc create_root_design { parentCell } {
  ...
  set HDPyx_SPI_CLK [ create_bd_port -dir O -type clk HDPyx_SPI_CLK ]
  set HDPyx_SPI_MISO [ create_bd_port -dir I HDPyx_SPI_MISO ]
  set HDPyx_SPI_MOSI [ create_bd_port -dir O HDPyx_SPI_MOSI ]
  set HDPyx_SPI_SS0 [ create_bd_port -dir O HDPyx_SPI_SS0 ]
  set RESET_N [ create_bd_port -dir O RESET_N ]
  set SDIO0_CDN [ create_bd_port -dir I SDIO0_CDN ]

  # Create instance: SS_override, and set properties
  set SS_override [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 SS_override ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_ACT_FPGA1_PERIPHERAL_FREQMHZ {49} \
   ...
   CONFIG.PCW_ACT_QSPI_PERIPHERAL_FREQMHZ {121} \
   ...
   CONFIG.PCW_ACT_TPIU_PERIPHERAL_FREQMHZ {10} \
   ...
   CONFIG.PCW_DDR_DDR_PLL_FREQMHZ {1584} \
   ...
   CONFIG.PCW_FPGA3_PERIPHERAL_FREQMHZ {33.333} \
   ...
   CONFIG.PCW_MIO_TREE_PERIPHERALS {GPIO#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#GPIO#Quad SPI Flash#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#UART 0#UART 0#UART 1#UART 1#GPIO#GPIO#GPIO#GPIO} \
   CONFIG.PCW_MIO_TREE_SIGNALS {gpio[0]#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]/HOLD_B#qspi0_sclk#gpio[7]#qspi_fbclk#gpio[9]#gpio[10]#gpio[11]#gpio[12]#gpio[13]#gpio[14]#gpio[15]#gpio[16]#gpio[17]#gpio[18]#gpio[19]#gpio[20]#gpio[21]#gpio[22]#gpio[23]#gpio[24]#gpio[25]#gpio[26]#gpio[27]#gpio[28]#gpio[29]#gpio[30]#gpio[31]#gpio[32]#gpio[33]#gpio[34]#gpio[35]#gpio[36]#gpio[37]#gpio[38]#gpio[39]#clk#cmd#data[0]#data[1]#data[2]#data[3]#rx#tx#tx#rx#gpio[50]#gpio[51]#gpio[52]#gpio[53]} \
   ...
   CONFIG.PCW_UIPARAM_ACT_DDR_FREQ_MHZ {396} \
  ...
  connect_bd_net -net HDPyx_SPI_MISO_1 [get_bd_ports HDPyx_SPI_MISO] [get_bd_pins processing_system7_0/SPI0_MISO_I]
  connect_bd_net -net SDIO0_CDN_1 [get_bd_ports SDIO0_CDN] [get_bd_pins processing_system7_0/SDIO0_CDN]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_ports FCLK_CLK1] [get_bd_pins processing_system7_0/FCLK_CLK1]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_ports RESET_N] [get_bd_pins processing_system7_0/FCLK_RESET0_N]
  connect_bd_net -net processing_system7_0_SPI0_MOSI_O [get_bd_ports HDPyx_SPI_MOSI] [get_bd_pins processing_system7_0/SPI0_MOSI_O]
  connect_bd_net -net processing_system7_0_SPI0_SCLK_O [get_bd_ports HDPyx_SPI_CLK] [get_bd_pins processing_system7_0/SPI0_SCLK_O]
  connect_bd_net -net processing_system7_0_SPI0_SS_O [get_bd_ports HDPyx_SPI_SS0] [get_bd_pins processing_system7_0/SPI0_SS_O]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins SS_override/dout] [get_bd_pins processing_system7_0/SPI0_SS_I]
